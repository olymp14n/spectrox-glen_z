...
void fx_glenz_modifyCubeVerticesToPyramid(fw_object_3d *object3D, float p) {
    object3D->v[10].y = (1.f-p) * 1.f + p * 2.73f;

    object3D->v[0].x = (1.f-p) * -1.f + p * -2.1f;
    object3D->v[0].z = (1.f-p) * 1.f + p * 2.1f;

    object3D->v[1].x = (1.f-p) * 1.f + p * 2.1f;
    object3D->v[1].z = (1.f-p) * 1.f + p * 2.1f;

    object3D->v[4].x = (1.f-p) * -1.f + p * -2.1f;
    object3D->v[4].z = (1.f-p) * -1.f + p * -2.1f;

    object3D->v[5].x = (1.f-p) * 1.f + p * 2.1f;
    object3D->v[5].z = (1.f-p) * -1.f + p * -2.1f;

    object3D->v[8].z = (1.f-p) * 1.f + p * 1.575f;
    object3D->v[9].z = (1.f-p) * -1.f + p * -1.575f;

    object3D->v[12].x = (1.f-p) * 1.f + p * 1.575f;
    object3D->v[13].x = (1.f-p) * -1.f + p * -1.575f;
}
